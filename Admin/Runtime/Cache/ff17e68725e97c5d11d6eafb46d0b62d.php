      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-title">用户ip</th>
                <th class="table-date">显示名称</th>
                <th class="table-date">注册时间</th>
                <th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
          <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$us): $mod = ($i % 2 );++$i;?><tr>
              <td><?php echo ($us['uip']); ?></td>
              <td><?php echo ($us['uname']); ?></td>
              <td><?php echo ($us['utime']); ?></td>
              <td>
