...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑选项</strong> / <small></small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" name="form1" action="__URL__/upx1"  method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">名称</label>
            <div class="am-u-sm-9">
              <input type="text" id="user-name" name="name" value="<?php echo ($theme["name"]); ?>" >
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-email" placeholder="默认不填为0" name="num" value="<?php echo ($theme["num"]); ?>" >
         ...
         <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class=""  rows="5" id="myEditor" name="vcontent"><?php echo ($theme["vcontent"]); ?></textarea>
              <small></small>
            </div>
          </div>
         <div  class="am-form-group">
	    ...
	    <div class="am-u-sm-9">
         <select name="ztx">
             <?php if($theme["ztx"] == 0): ?><option value="0" selected="selscted">开启</option>
		   ...
		   <div>
            ...
            <div class="am-u-sm-9 am-u-sm-push-3">
                <input value=<?php echo ($theme["id"]); ?> name="id" type="hidden" id="id" >
