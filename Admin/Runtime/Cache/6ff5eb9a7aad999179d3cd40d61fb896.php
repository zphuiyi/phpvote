...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">留言</strong> / <small></small> </div>
    </div>
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-date">查看留言</th>
                <th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
          <?php if(is_array($liu)): $i = 0; $__LIST__ = $liu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i;?><tr>
              <td><?php echo ($th["title"]); ?></td>
              <td><a href="__URL__/liu/tid/<?php echo ($th["tid"]); ?>">查看留言</a></td>
              <td>
