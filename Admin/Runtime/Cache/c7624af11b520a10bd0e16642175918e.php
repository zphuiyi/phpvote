...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">投票</strong> / <small><a href="javascript:history.go(-1);">查看选项</a></small>
      <br/>
<?php $tid=$_GET[tid] ?>
          <?php if($tid != null): else: ?>
              <small><a href="__URL__/xvote/tid/<?php echo ($theme1["vid"]); ?>">查看全部投票</a></small><?php endif; ?>
      </div>
    </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-date">IP</th>
                <th class="table-date">名称</th>
          ...
          <?php if(is_array($theme)): $i = 0; $__LIST__ = $theme;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i;?><tr>
              <td><?php echo ($th['ip']); ?></td>
              <td><?php echo ($th['name']); ?></td>
               <td><?php echo ($th['time']); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a href="__URL__/de/id/<?php echo ($th["id"]); ?>">删除</a>
                  </div>
                </div>
              </td>
