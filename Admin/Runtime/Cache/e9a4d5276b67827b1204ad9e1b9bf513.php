...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="__URL__/liuyan">留言</a></strong> / <small><a href="__URL__/liu/tid/<?php echo ($theme["tid"]); ?>"><?php echo ($theme["title"]); ?></a></small> </div>
    </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-title">选项名称</th>
                <th class="table-date">用户</th>
                  <th class="table-date">内容</th>
                  <th class="table-date">审核</th>
                <th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
          <?php if(is_array($vliu)): $i = 0; $__LIST__ = $vliu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i;?><tr>
              <td><?php echo ($th["name"]); ?></td>
              <td>
               <?php if($th["uname"] == null): ?>---
                   <?php else: ?>
                  <?php echo ($th["uname"]); endif; ?>
              </td>
                <td><?php echo ($th["content"]); ?></td>
                <td>
                    <?php if($th["xs"] == 0): ?>通过
                        <?php else: ?>
                        未通过<?php endif; ?>
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a href="__URL__/xliu/id/<?php echo ($th["id"]); ?>"><span class="am-icon-pencil-square-o"></span>编辑</a>
                  </div>
                </div>
              </td>
