...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新建活动</strong> / <small><a href="javascript:history.go(-1);">返回</a></small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" name="form1" action="__URL__/add"  method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">活动名称</label>
            <div class="am-u-sm-9">
              <input type="text" id="user-name" name="title">           
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
                ...
                <input class="jcDate " name='startime' style="width:210px; height:30px; line-height:20px; padding:4px;" />
                <input class="jcDate " name='endtime' style="width:210px; height:30px; line-height:20px; padding:4px;" />
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
                <input class="jcDate " name='startime1' style="width:210px; height:30px; line-height:20px; padding:4px;" />
                <input class="jcDate " name='endtime1' style="width:210px; height:30px; line-height:20px; padding:4px;" />
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="user-intro" name="votegy"></textarea>
              <small></small>
            </div>
          </div>
                    <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="user-intro" name="votesm"></textarea>
              <small></small>
            </div>
          </div>
         <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class=""  rows="5" id="myEditor" name="content"></textarea>
              <small></small>
            </div>
          </div>
         <div  class="am-form-group">
	    ...
	    <div class="am-u-sm-9">
         <select name="zt">			         			       
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <input type="text" id="user-name" name="vote" >
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <input type="text" id="user-name" name="vote_day">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <input type="text" id="user-name" name="vote_item">
