...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">活动</strong> / <small><a href="__URL__/launch">新建活动</a></small> </div>
    </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-date">活动是否开启</th>
                  <th class="table-date">活动投票项</th>
          ...
          <?php if(is_array($theme)): $i = 0; $__LIST__ = $theme;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo ($th['startime']); ?></td>
              <td><?php echo ($th['endtime']); ?></td>
              <td>
               ...
               <td><a href="__URL__/listrx/tid/<?php echo ($th["tid"]); ?>">查看</a></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a href="__URL__/opti/tid/<?php echo ($th["tid"]); ?>"><span class="am-icon-pencil-square-o"></span>编辑</a>                 
                  </div>
                </div>
              </td>
